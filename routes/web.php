...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    // Route Kelola Siswa & Import Excel
...
// ==========================================
// 3. GROUP ROUTE KHUSUS GURU / WALI KELAS
// ==========================================
...
// ==========================================
// 6. ROUTE AKSES BERSAMA (SEMUA USERS AUTH)
// ==========================================
Route::middleware('auth')->group(function () {
    ...
    Route::get('/teacher/permissions', [PermissionController::class, 'indexTeacher'])->name('teacher.permissions.index');
    Route::post('/teacher/permissions/{id}/update', [PermissionController::class, 'updateStatus'])->name('teacher.permissions.update');
